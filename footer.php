                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mt-4">
                        ...
                        <ul class="nav justify-content-center">
                            ...
                            <li class="nav-item"><a href="#" class="nav-link text-white">Sobre</a>
                    ...
                    <div class="col-md-4 mt-4">
                        ...
                        <ul class="nav justify-content-center">
                            ...
                            <li class="nav-item"><a href="#" class="nav-link text-white"><i class="fab fa-twitter-square" id="icon-twi"></i></a>
                            <li class="nav-item"><a href="#" class="nav-link text-white"><i class="fab fa-instagram" id="icon-insta"></i></a>
                        </ul>
                    </div>
                </div>
            </div>
